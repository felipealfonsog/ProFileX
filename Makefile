#############################################################################
# Makefile for building: proFileX
# Generated by qmake (3.1) (Qt 5.15.14)
# Project:  proFileX.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile proFileX.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = proFileX1.0.0
DISTDIR = /home/felipe/Development/ProFileX/.tmp/proFileX1.0.0
LINK          = g++
...
proFileX: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: proFileX.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
